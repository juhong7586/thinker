  ...
  return (
    <>
      ...
      <div className={styles.container} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ width: 380, background: 'rgba(255,255,255,0.95)', padding: '1.5rem', borderRadius: 12, boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }}>
          ...
          <input value={name} onChange={(e) => setName(e.target.value)} type="text" style={{ width: '100%', padding: 10, borderRadius: 8, border: '1px solid #ddd', marginBottom: 10 }} />

          <label style={{ display: 'block', fontSize: 13, color: '#333', marginBottom: 6 }}>Email</label>
          <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" style={{ width: '100%', padding: 10, borderRadius: 8, border: '1px solid #ddd', marginBottom: 10 }} />

          <label style={{ display: 'block', fontSize: 13, color: '#333', marginBottom: 6 }}>Personal color</label>
          <input value={color} onChange={(e) => setColor(e.target.value)} type="color" style={{ width: '64px', height: '40px', padding: 6, borderRadius: 6, border: 'none', marginBottom: 12 }} />
